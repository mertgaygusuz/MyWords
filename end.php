            ...
            <div class="row align-items-sm-center align-items-lg-stretch">
                     <div class="wrapper">
                        <div>
                            ...
                            <h3 class="username">Tebrikler <span class="name"></span></h3>
                            <p class="userpoints">Skorun : <span class="points"></span></p>
                            <p class="usertime"> Tamamladığın süre : <span class="time_taken"></span> Saniye</p>
                        </div>
                    </div>
